...
| :--- | :--- | :--- |
| **September** | Week 1: Access and explore corpus (NPR Standards and Handbook)/n Week 2: Load PDF and create function (Regex?, or...) for Parsing and extracting the relevant clauses,  Parse NASA NPR 7150.2 into structured clause chunks./n Week 3: Benchmark Setup: CA will create a labeled ground-truth benchmark (30–50 requirement/clause pairs) with seeded compliance gaps and draft an accompanying Data Card./ n Week 4: Build baseline model, starting with rules, keywords, TF-IDF, etc. (no LLM yet)|
