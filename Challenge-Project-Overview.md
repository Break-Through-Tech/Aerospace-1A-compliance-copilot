...
| :--- | :--- | :--- |
| **September** | Week 1: Access Data | Access and explore corpus (NASA NPR 7150.2 Standards and Handbook) | Week 2: Parse and Triage | Load PDF and create function (Regex?, or...) for extracting the relevant structured clause chunks; create dataframe and produce data annotations | Week 3: Benchmark Setup| CA will create a labeled ground-truth benchmark (30–50 requirement/clause pairs) with seeded compliance gaps and draft an accompanying Data Card./ n Week 4: Build baseline model, starting with rules, keywords, TF-IDF, etc. (no LLM yet)|
